...
sheet_to_model = [
    ...
    models.fieldwork.lifecycle_profile_activity_association,
    models.fieldwork.CostType,
    models.fieldwork.Cost,
]
...
def seed_data_from_sheet(df, model):
    print(model)
    if model in [models.fieldwork.lifecycle_profile_activity_association]:
        print(df)
