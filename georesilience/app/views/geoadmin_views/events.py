...
from .myview import GeoView


class EventView(GeoView):
    # Define fields to be displayed in the list view
    column_list = ["name", "timestamp", "intensity", "description"]
    ...
    form_rules = (
        (
            (rules.HTML("<div><h3 style='text-align: center;'>On Events</h3></div>"),),
            (
                rules.HTML(
